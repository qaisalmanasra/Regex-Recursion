...
/* Write a function that take a sing and return true if the sing only contain uppercase and lowercase
...
/* Write a function that take a sing and return true if the the sting is following the emails pattern
...
function imagesSearcher(text){
    ...
    let regex = /dog.jpg/
        ...
        let regex2 = /cow.jpeg/
        let arr2 = text.match(regex2)
        let regex3 = /cat.png/
        let arr3 = text.match(regex3)
